 ...
 *   entirety and paste it here, changing the prefix from theme_ to usahifi_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: usahifi_breadcrumb()
 *
 *   where usahifi is the name of your sub-theme. For example, the
...
if (theme_get_setting('usahifi_fixed')) {
 ...
 */
function usahifi_theme(&$existing, $type, $theme, $path) {
 ...
 */
function usahifi_preprocess_page(&$vars, $hook) {
  /**
...
*   An array of variables to pass to the theme template.
*/
function usahifi_preprocess_node(&$vars, $hook) {
  $node = $vars['node'];
...
function usahifi_preprocess_comment(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function usahifi_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 * @ingroup themeable
 */
function usahifi_uc_product_image($images, $teaser = 0, $page = 0) {
  // get nid
 ...
 * @ingroup themeable
 */
function usahifi_button($element) {
...
function usahifi_submit($element) {
...
*/
function usahifi_preprocess_search_theme_form(&$vars, $hook) {
 ...
 */
function usahifi_preprocess_search_result(&$vars, $hook) {
  $result = $vars['result'];
  $nid = $result['node']->nid;
  $vars['nid'] = $nid;
 ...
 */
function usahifi_uc_catalog_product_grid($products) {
 ...
 * @ingroup themeable
 */
function usahifi_uc_catalog_browse($tid = 0) {
 ...
 * @ingroup themeable
 */
function usahifi_uc_price($value, $context, $options) {
  // Fixup class names.
 ...
 * @see uc_price()
 */
function usahifi_uc_product_price($price, $context, $options = array()) {
 ...
 */
function usahifi_views_slideshow_div_js($rows, $options, $id) {
  $hover = 'hover';
...
function usahifi_status_messages($display = NULL) {
  $output = '';
