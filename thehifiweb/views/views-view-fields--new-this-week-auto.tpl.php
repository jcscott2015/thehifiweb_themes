<?php
// $Id: views-view-fields--new-this-week-auto.tpl.php,v 1.6 2008/09/24 22:48:21 merlinofchaos Exp $
/**
...
<?php
	...
	if (floatval(mb_substr($stripped_rows['sell_price'], 1)) > 0) {
		...
		unset($my_rows['list_price']);
		// Change price-ours class to price-reg.
		$my_rows['sell_price']->content = '<span class="price-ours">FREE</span>';
	}
?>
