      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><strong><?php echo t('Thanks for your order, !order_first_name!', array('!order_first_name' => $order_first_name)); ?></strong></p>

            <?php if (isset($_SESSION['new_user'])) { ?>
            <p><strong><?php echo t('An account has been created for you with the following details:'); ?></strong></p>
            <p><strong><?php echo t('Username:'); ?></strong> <?php echo $new_username; ?><br />
            <strong><?php echo t('Password:'); ?></strong> <?php echo $new_password; ?></p>
            <?php } ?>

            <p><strong><?php echo t('Want to manage your order online?'); ?></strong><br />
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#006699" style="color: white;">
                  <strong><?php echo t('Purchasing Information:'); ?></strong>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
                  <strong><?php echo t('Order Date:'); ?></strong>
                </td>
                <td width="98%">
                  <?php echo $order-date-created; ?>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
                  <strong><?php echo t('E-mail Address:'); ?></strong>
                </td>
                <td width="98%">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    <tr>
                      <td valign="top" width="50%">
                        <strong><?php echo t('Billing Address:'); ?></strong><br />
                        <?php echo $order_billing_address; ?><br />
                        <br />
                        <strong><?php echo t('Billing Phone:'); ?></strong><br />
                        <?php echo $order_billing_phone; ?><br />
                      </td>
                      <?php if (uc_order_is_shippable($order)) { ?>
                      <td valign="top" width="50%">
                        <strong><?php echo t('Shipping Address:'); ?></strong><br />
                        <?php echo $order_shipping_address; ?><br />
                        <br />
                        <strong><?php echo t('Shipping Phone:'); ?></strong><br />
              ...
              <tr>
                <td nowrap="nowrap">
                  <strong><?php echo t('Order Grand Total:'); ?></strong>
                </td>
                <td width="98%">
              ...
              <tr>
                <td nowrap="nowrap">
                  <strong><?php echo t('Payment Method:'); ?></strong>
                </td>
                <td width="98%">
              ...
              <tr>
                <td colspan="2" bgcolor="#006699" style="color: white;">
                  <strong><?php echo t('Order Summary:'); ?></strong>
                </td>
              </tr>
              ...
              <tr>
                <td colspan="2" bgcolor="#EEEEEE">
                  <font color="#CC6600"><strong><?php echo t('Shipping Details:'); ?></strong></font>
                </td>
              </tr>
              <?php } ?>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <strong><?php echo t('Shipping Method:'); ?></strong>
                      </td>
                      <td width="98%">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <strong><?php echo t('Total for this Order:'); ?>&nbsp;</strong>
                      </td>
                      <td>
                        <strong><?php echo $order_total; ?></strong>
                      </td>
                    ...
                    <tr>
                      <td colspan="2">
                        <br /><br /><strong><?php echo t('Products on order:'); ?>&nbsp;</strong>
                        ...
                        <table width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                          ...
                          <tr>
                            <td valign="top" nowrap="nowrap">
                              <strong><?php echo $product->qty; ?> x </strong>
                            </td>
                            <td width="98%">
                              <strong><?php echo $product->title .' - '. uc_price($price_info, $context); ?></strong>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <?php if ($help_text) { ?>
                  <p><strong><?php echo t('Where can I get help with reviewing my order?'); ?></strong><br />
                  ...
                  <?php if ($store_footer) { ?>
                  <p><strong><?php echo $store_link; ?></strong><br /><strong><?php echo $site_slogan; ?></strong></p>
                  <?php } ?>
                </td>
              </tr>
              <?php } ?>
