   ...
   <div id="header-group" class="clear-block">
    ...
    <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box || $primary_links || $secondary_links || $navbar) { print ' with-navbar'; } ?>">
      ...
      <div id="content"><div id="content-inner">
		...
		<?php
			$products_on_sale = module_invoke('views', 'block', 'view', 'products_on_sale-block_1');
			echo '<h2 class="products-on-sale-title">'.$products_on_sale['subject'].'</h2>';
			echo $products_on_sale['content'];
		?>
